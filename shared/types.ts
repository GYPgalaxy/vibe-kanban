...
export type DraftWorkspaceData = { message: string, repos: Array<DraftWorkspaceRepo>,
/**
 * Whether the user has explicitly confirmed or modified the repo picker.
 */
has_user_touched_repos: boolean, executor_config: ExecutorConfig | null, linked_issue: DraftWorkspaceLinkedIssue | null, attachments: Array<DraftWorkspaceAttachment>, };
