...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::task::BulkUpdateTaskItem::decl(),
        ...
        server::routes::projects::BulkUpdateTasksRequest::decl(),
        server::routes::projects::BulkUpdateTasksResponse::decl(),
        ...
        server::routes::direct_hosts::DirectHostStatus::decl(),
        server::routes::direct_hosts::DirectHost::decl(),
        server::routes::direct_hosts::CreateDirectHostRequest::decl(),
        server::routes::direct_hosts::UpdateDirectHostRequest::decl(),
        server::routes::direct_hosts::ListDirectHostsResponse::decl(),
    ...
    trim_trailing_whitespace(&format!("{HEADER}\n\n{body}\n\n{constants}"))
}
